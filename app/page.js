...
const testimonials = [
  {
    ...
    initials: 'AR',
    rating: 5,
    text: 'Apne bhai ki shaadi ke liye Mesh Bracelet & Ring Set order kiya tha. Gold plating mahinon baad bhi bilkul nayi lagti hai. Har rupee worth hai.',
  },
  {
    name: 'Ayesha Khan',
    location: 'Karachi',
    initials: 'AK',
    rating: 5,
    text: 'Online jewelry order karne se pehle thora shak tha lekin Yin Yang bracelet set expectations se zyada nikla. Packaging khud hi luxury unboxing jaisi lagi.',
  },
  {
    name: 'Bilal Ahmed',
    location: 'Islamabad',
    initials: 'BA',
    rating: 4,
    text: 'Cash on Delivery ki wajah se order karna asaan laga. Crown Signet Ring perfect fit hai aur gym sessions ke baad bhi tarnish nahi hui.',
  },
  {
    name: 'Sana Malik',
    location: 'Faisalabad',
    initials: 'SM',
    rating: 5,
    text: 'Gift ke liye li thi, 3 din mein pohanch gayi. Husband ko pasand aya ke bangle se wrist green nahi hoti jaisa purani jewelry se hota tha.',
  },
  {
    name: 'Hamza Sheikh',
    location: 'Rawalpindi',
    initials: 'HS',
    rating: 5,
    text: 'Genuinely waterproof hai — bracelet pehen kar kai baar swim kiya, ab bhi bilkul flawless hai. WhatsApp support bhi bohat responsive tha.',
  },
  {
    name: 'Zainab Iqbal',
    location: 'Multan',
    initials: 'ZI',
    rating: 4,
    text: 'Price ke hisab se quality bohat achi hai. Delivery expected se thori late hui lekin product ne kami poori kar di.',
  },
];
